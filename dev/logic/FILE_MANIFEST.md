...
| core/dashboard/dashboard.py | 5.0.0 | Fleet-ready dashboard with Alpaca REST telemetry on port 32323. |
...
| core/flight/camera_control.py.bak | 2.0.0 | Hardware status interface for ZWO S30-Pro via Sovereign TCP. |
| core/flight/dark_library.py | 2.0.0 | Post-session dark frame acquisition via Alpaca REST. |
| core/flight/dark_library.py.bak | 1.0.0 | Post-session dark frame acquisition via firmware start_create_dark. |
...
| core/flight/neutralizer.py.bak | 3.0.1 | Hardware reset — stops any active S30-Pro session and verifies idle state before handing control to the pilot. |
| core/flight/orchestrator.py | 1.7.0 | Full pipeline state machine wired to the TCP Diamond Sequence via the SovereignFSM. |
| core/flight/pilot.py | 3.0.0 | Full Alpaca REST control of ZWO S30-Pro for AAVSO-compliant |
| core/flight/pilot.py.v1.7.1.bak | 2.0.0 | Direct control of ZWO S30-Pro for AAVSO-compliant Sovereign RAW |
...
| core/preflight/hardware_audit.py.bak | 2.0.0 | Sovereign TCP hardware audit via get_device_state on port 4700. |
...
| dev/logic/DISCOVERY_PROTOCOL.MD | N/A | ** Network discovery and hardware identification for Seestar telescopes. |
...
| dev/logic/STATE_MACHINE.md | N/A | ** Deterministic hardware transitions for AAVSO acquisition |
| dev/logic/WORKFLOW.md | N/A | No objective defined. |
| dev/logic/SEEVAR_SKILL/SKILL.md | N/A | No objective defined. |
| dev/alpaca/test_camera_exposure.py | N/A | No objective defined. |
...
| data/test_frames/wilhelmina_test_20260330_152631.fits | N/A | No objective defined. |
