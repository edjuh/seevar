...
| core/preflight/stellarium_panorama_capture.py | 1.1.0 | Slews the Seestar around the horizon, switches into a requested view mode, and captures panorama inputs via RTSP or a mounted media share. |
