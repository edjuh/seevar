...
| core/flight/exposure_planner.py | 1.0.1 | Estimate optimal exposure time for a target given magnitude, sky conditions and desired SNR. Feeds orchestrator exp_ms. |
