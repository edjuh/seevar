    ...
    for entry in seestars:
        ...
        if state:
            ...
            fleet.append({
                ...
                "battery": state.get("battery", state.get("battery_pct")),
                "charge_online": state.get("charge_online"),
            ...
            if previous_good and failures == 1:
                ...
                fleet.append({
                    ...
                    "battery": transient.get("battery", transient.get("battery_pct")),
                    "charge_online": transient.get("charge_online"),
                    "charger_status": transient.get("charger_status"),
